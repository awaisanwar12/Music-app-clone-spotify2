...
const DetailsHeader = ({ artistId, artistData, songData }) => {
  const artist = artistData?.artists[artistId]?.attibutes;
  ...
  return (
    <div className="relative w-full flex flex-col ">
      ...
      <div className="absolute inset-0 flex items-center">
        ...
        <img
          alt="art"
          src={artistId ? artist?.artists[artistId].attributes?.artwork?.url.replace('{w}', '500').replace('{h}', '500') : songData?.images?.coverart}
